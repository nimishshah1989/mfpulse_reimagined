...
class RiskStatsMonthly(Base, UUIDPrimaryKey):
    ...
    cat_sortino_10y: Mapped[None] = _col()
    cat_kurtosis_1y: Mapped[None] = _col()
    cat_kurtosis_3y: Mapped[None] = _col()
    cat_kurtosis_5y: Mapped[None] = _col()
    cat_kurtosis_10y: Mapped[None] = _col()
    cat_skewness_1y: Mapped[None] = _col()
    cat_skewness_3y: Mapped[None] = _col()
    cat_skewness_5y: Mapped[None] = _col()
    cat_skewness_10y: Mapped[None] = _col()
    cat_capture_up_1y: Mapped[None] = _col()
    cat_capture_up_3y: Mapped[None] = _col()
    cat_capture_up_5y: Mapped[None] = _col()
    cat_capture_up_10y: Mapped[None] = _col()
    cat_capture_down_1y: Mapped[None] = _col()
    cat_capture_down_3y: Mapped[None] = _col()
    cat_capture_down_5y: Mapped[None] = _col()
    cat_capture_down_10y: Mapped[None] = _col()
    cat_correlation_1y: Mapped[None] = _col()
    cat_correlation_3y: Mapped[None] = _col()
    cat_correlation_5y: Mapped[None] = _col()
    cat_correlation_10y: Mapped[None] = _col()
    cat_info_ratio_1y: Mapped[None] = _col()
    cat_info_ratio_3y: Mapped[None] = _col()
    cat_info_ratio_5y: Mapped[None] = _col()
    cat_info_ratio_10y: Mapped[None] = _col()
    cat_tracking_error_1y: Mapped[None] = _col()
    cat_tracking_error_3y: Mapped[None] = _col()
    cat_tracking_error_5y: Mapped[None] = _col()
    cat_tracking_error_10y: Mapped[None] = _col()
    cat_treynor_1y: Mapped[None] = _col()
    cat_treynor_3y: Mapped[None] = _col()
